...
class Addfee extends Base_Admin_Controller
{
    ...
    public function getfeeHead(){
        ...
        $result['feeshead'] = $this->Schoolfees->feeshadforschool($data);
        //echo '<pre>';print_r($result);die();
        	echo $this->load->view('admin/fee_management/feeheaddrop', $result, true);
        }
    ...
    public function getschoolname(){
       ...
       // echo $data['school_name'];die();
        ...
        $result['auto_comp'] = $this->Schoolfees->autocompSchool($data);
        	...
        	echo $this->load->view('admin/fee_management/schoolname', $result, true);
    ...
    public function editfeepage(){
        ...
        $this->load->view('admin/fee_management/editfessdata',$data);
    ...
    public function updatefees(){
       // echo '<pre>';print_r($_POST);die();
        ...
        redirect("admin/Addfee/editfee/".$this->input->post('school_id'), 'refresh');
    ...
    public function edittransportfee(){
      ...
      //   }
         ...
         if(isset($id)){
            ...
            if($routedeatils !="" && (!empty($routedeatils)) ){
               // echo 'dadadadda';die();
                $this->data['routefeedetails']=$routedeatils;
            $this->data['school_id']=$this->uri->segment(4);
            //echo '<pre>';print_r($routedeatils);die();
            $this->_loadView('admin/fee_management/edittransportfee');
            }else{
    ...
    public function getschoolnamefortransport(){
       ...
       // echo $data['school_name'];die();
        ...
        $result['auto_comp'] = $this->Schoolfees->autocompSchool($data);
       	...
       	echo $this->load->view('admin/fee_management/schoolnamefortransport', $result, true);
    }
    ...
    public function updatetransportfee(){
        ...
        redirect("admin/Addfee/edittransportfee/".$this->input->post('school_id'), 'refresh');
