...
<?php if(isset($schools_id)){ ?>
    ...
    <div class="row">
            ...
            <?php echo form_open_multipart('admin/Studentmanagement/advancesearch', array('id' =>"advancedSearch"))?>            
              ...
              <div class="col s12 l3">
                <div class="form-group no-margin">
                  <input type="text" id="" name="class" placeholder="Class" class="form-control">
                </div>
              </div>
              <input type="hidden" id="" name="school_id"  class="form-control" value="<?php if(isset($schools_id)){echo $schools_id;}?>">
              <div class="col s12 l3">
                <div class="form-group no-margin">
                  <input type="text" id="" name="section" placeholder="Section" class="form-control">
                </div>
              </div>
             
              <div class="col s12 l3">
                <div class="form-group no-margin">
                  <input type="text" id=""  name="roll" placeholder="Roll No." class="form-control">
                </div>
              </div>
          ...
          <div class="row">
            ...
            <button class="btn waves-effect waves-light indigo right" type="submit" name="submit" value="submit">Promote Submit</button>
              </div>
            ...
            <div class="col s12 l4 right"  style="padding-top: 0; margin-top: 0;"> 
           ...
           <!-- <button class="dropdown-button btn-floating btn-flat waves-effect waves-light  pink accent-2 white-text right" type="submit" name="submit" value="submit"><i class="mdi-editor-publish"></i></button> -->
...
foreach($allStudents as $key=> $studentrow){
    ...
    ?>
                ...
                <tr>
                  ...
                  <td><a href="#"><i class="mdi-action-view-headline"></a></td>
                </tr>
                <?php }} ?>
              </tbody>
            </table>
