...
<div class="row">
          ...
          <input type="text" id="search_school" class="validate">
          <label for="icon_prefix">Search Schools</label>
        </div>
         <div id="sc_name"></div>
                </div> 
              </div>
       ...
       ?>
            ...
            foreach($routefeedetails as $key=> $routedetails){ ?>
              <?php echo form_open("admin/addfee/updatetransportfee/".$routedetails['routefees_id'] ); ?>   
