...
<div class="main-content">
  ...
  <tr>
    ...
    <td width="30%"><select class="form-control" name="upto_bothway" style="width: 85px;" id="">
    <?php  for($i=1;$i<=20;$i++){ ?>
 ...
 <tr>
    <td>Beyond</td>
    <td><select class="form-control" name="beyond_bothway" style="width: 85px;" id="">
                        <?php  for($j=1;$j<=20;$j++){ ?>
...
<div class="col-sm-6">
  ...
  <tr>
    <td width="20%">Up to </td>
    <td width="30%"><select class="form-control" name="upto_oneway" style="width: 85px;" id="">
                         <?php  for($k=1;$k<=20;$k++){ ?>
 ...
 <tr>
    <td>Beyond</td>
    <td><select class="form-control" name="beyond_oneway" style="width: 85px;" id="">
                         <?php  for($l=1;$l<=20;$l++){ ?>
 ...
 <tr>
    ...
    <select class="form-control" name="route_oneway" id="route_oneway">
         ...
         <span class="route_plus"><a href="#" data-toggle="modal" data-target="#pluspopup2"><span class="glyphicon glyphicon-plus"></span></a></span>
    </td>
    <td>Amount</td>
    ...
    <div class="modal-content" style="width:430px;">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form">
          ...
          <button class="btn btn-info pull-right" type="button"> <i class="ace-icon fa fa-check bigger-110"></i> Submit </button>
          <div class="clearfix"></div>
        </form>
      </div> 
       <!--<div class="modal-footer">
