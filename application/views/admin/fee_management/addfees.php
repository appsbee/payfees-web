...
?>
      ...
      <section id="content">
        ...
        <div class="container">
          ...
          <select class="form-control browser-default" name="schoolname" id="schoolname">
          ...
          <option value="">Select School</option>
            ...
            foreach($schools as $school){
                ...
                <div style="clear: both;"></div>
                    ...
                    <div class="col form-control s12 m4 l4">
                        <strong id="fees_label" style="padding-top: 30px;  float: left;">Fees Head:</strong>
                    </div>
                    
                    <div class="col s12 m4 l3 input-field">
                    <p id="f_head" style="color: blue;"></p>
                    <!--  <select class="form-control browser-default" name="f_head" id="f_head"> -->
                    ...
                    <div class="col s12 m4 l4 input-field">
                     ...
                     <a class="waves-effect waves-light btn modal-trigger right" href="#myModal" id="addfhead"> <i class="mdi-image-control-point left"></i> Add Fee Head</a>
          ...
          <div class="col s12 m4 l12" style="text-align:center;">
            <p style="color:green"><?php echo $this->session->flashdata('add_success'); ?>
              ...
              <input type="hidden" name="schoolname" id="schoolonchnageid" value="" />      
                ...
                <div class="col s12 m12 l12">
                  <table class="responsive-table">
                    ...
                    <tbody>
                      ...
                      <tr> 	 	 		
                        <td><strong>Frequencyssss</strong></td>
...
$( "#schoolname" ).change(function() {
  ...
  $("#schoolonchnageid").val(school_id);
  
  
  $.ajax({
		type: "GET",
		//dataType: "html",
		url: '<?php echo site_url() ?>/admin/Addfee/getfeeHead',
		data: {
			'school_id': school_id
		},
    ...
    if(feeshead !=""){
		...
		success: function(resp) {
          ...
          if(resp.trim()!="error"){
            ...
            $("#f_head").html(feeshead)
            
          //$("#f_head").prepend('<option value="'+resp+'" selected>'+feeshead+'</option>')
          
 		  
          $("#sucess").html("Fees Head Add Sucessfully");
          $('#myModal').closeModal();
            
          }
          else{
            $("#error").html("Fees Head  Already Exists");
          }
