    ...
    <div class="main-content-inner">
        ...
        <div class="row">
          <div class="col-xs-12 top_gap">
            ...
            <?php echo form_open("admin/addfee/insertfees"); ?>
            <p class="bg-info"><?php echo $this->session->flashdata('add_success'); ?>
                    </p>            
            <input type="text" name="feesname" id="feesname" value="" />
            <input type="text" name="feesid" id="feesid" value="" />
            ...
            <div class="row top_gap">
              <table id="simple-table" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td><input type="text" name="cls1fessamopunt" class="form-control"/></td>
                    <td><input type="text" name="cls2fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls3fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls4fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls5fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls6fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls7fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls8fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls9fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls10fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls11fessamopunt" class="form-control"></td>
                    <td><input type="text" name="cls12fessamopunt" class="form-control"></td>
                  </tr>
                  <tr>
                    <td><strong>Frequency</strong></td>
                    <td><select class="form-control" name="cls1frequency" id="cls1frequency">
                    ...
                    <td><select class="form-control" name="cls2frequency" id="cls2frequency">
                        <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls3frequency" id="cls3frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls4frequency" id="cls4frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls5frequency" id="cls5frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls6frequency" id="cls6frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls7frequency" id="cls7frequency">
                        <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls8frequency" id="cls8frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls9frequency" id="cls9frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls10frequency" id="cls10frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls11frequency" id="cls11frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                    ...
                    <td><select class="form-control" name="cls12frequency" id="cls12frequency">
                         <option value="">Select</option>
                        <option value="Monthly">Monthly</option>
                        <option value="Half yearly">Half yearly</option>
                        <option value="Yearly">Yearly</option>
                  ...
                  <tr>
                    ...
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls2duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls3duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls4duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls5duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls6duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls7duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls8duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls9duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls10duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls11duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls12duedate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><div class="input-group">
                        ...
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls2lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls3lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls4lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls5lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls6lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls7lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls8lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls9lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls10lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls11lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                    <td><div class="input-group">
                        <input class="form-control date-picker" name="cls12lastdate" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span> </div></td>
                  </tr>
                  <tr>
