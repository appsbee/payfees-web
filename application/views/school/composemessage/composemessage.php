            ...
            <div class="col s12 l3">
                ...
                <label for="notice">Send Notice</label>
                       ...
                       <input type="text" name="type" id="type" value="" />
                        <input type="hidden" name="typeset" id="typeset" value="" />
                        <div class="row">
              ...
              <div class="multi_mail"><span>Send Message to:</span>
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="School" type="text" name="title">
...
$('body').on('click', '.remove',function(){
   ...
   //$('#messageresp').append('<li>'+finalcl+ '<a href="javascript:void(0)"> <strong class="remove">X</strong></a></li>');
   console.log(finalcl);
