...
<div class="row">
          ...
          <label for="icon_prefix">Type your query</label>
                 ...
                 <?php echo form_open("school/addfee/inserttransportfee"); ?>
...
<i class="mdi-content-send right"></i>
          ...
          <input type="hidden" name="s_name" id="s_name" value="<?php echo $getSchoolname['school_name']; ?>" />
            <?php echo form_close(); ?>
 ...
 <!-- Modal Structure -->
  <div class="modal"   id="addroutebothway" role="dialog">
    <div class="modal-content">
      ...
      <?php echo form_open("school/addfee/insertroute"); ?>
